public class KDTree {
    ...
    KdNode minNode(KdNode root, KdNode leftMin, KdNode rightMin, int i) {
        ...
        KdNode minNode ;
        minNode = (leftMin  != null &&  leftMin.bank.coordinate[i]<root.bank.coordinate[i])    ? leftMin : root ;
        minNode = (rightMin != null && rightMin.bank.coordinate[i]<minNode.bank.coordinate[i]) ? rightMin : leftMin;
        return minNode;
    }
